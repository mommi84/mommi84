...
🔬 I recently worked on **AI-driven strategic foresight**, a novel intersectional field where language models are leveraged to forecast future events for strategic decision making. You can read [an open-access paper](https://arxiv.org/abs/2501.04880v1) on our most recent work which was published [in the proceedings of IEEE ICSC 2025](https://www.computer.org/csdl/proceedings-article/icsc/2025/242600a226/27FQF0bZore).
...
- **2010**: Built my first swarm of intelligent agents for a M.Sc. project
- **2012**: Published [my M.Sc. work](https://link.springer.com/chapter/10.1007/978-3-642-37996-3_7) on active learning for entity resolution
- **2016**: Started researching neuro-symbolic methods for question answering and link prediction
...
- **2018**: Implemented a generative AI model for the first time using LSTMs
- **2020**: Published [my first paper as a supervisor](https://arxiv.org/abs/2010.10900) on code generation for question answering
